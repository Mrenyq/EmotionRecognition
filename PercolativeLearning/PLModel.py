...
from tensorflow.keras.layers import Input, Dense, Activation, ReLU, BatchNormalization, concatenate
...
class PercolativeLearning(tf.keras.Model):

    def __init__(self, num_output=4):
        super(PercolativeLearning, self).__init__(self)

        # Dense(Percolation Network)
        self.perc_dense1 = Dense(units=512, name="perc_dense1")
        self.perc_dense2 = Dense(units=256, name="perc_dense2")
        self.perc_dense3 = Dense(units=128, name="perc_dense3")

        # Dense(Integration Network)
        self.int_dense1 = Dense(units=128, name="int_dense1")
        self.int_dense2 = Dense(units=64, name="int_dense2")
        self.int_dense3 = Dense(units=32, name="int_dense3")

        # logit
        self.logit = Dense(units=num_output, name="logit")

        # BatchNorm
        self.batch_norm_perc1 = BatchNormalization(name="batch_norm_perc1")
        self.batch_norm_perc2 = BatchNormalization(name="batch_norm_perc2")
        self.batch_norm_perc3 = BatchNormalization(name="batch_norm_perc3")
        self.batch_norm_int1 = BatchNormalization(name="batch_norm_int1")
        self.batch_norm_int2 = BatchNormalization(name="batch_norm_int2")
        self.batch_norm_int3 = BatchNormalization(name="batch_norm_int3")
